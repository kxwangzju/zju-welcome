...
学校并不会为新生自动激活校园网，在获得统一身份认证之后，新生需要先访问[信息技术中心网站](https://myvpn.zju.edu.cn)进行**激活账号**，此时也会完成浙大邮箱的激活，更详细的流程可以参考[此处](../network_detailed.md#vpn)。有10元/月、30元/月、50元/月三类套餐，越贵则上传下载速度越快。激活之后第一个月可免费上网，此后需要续费（海宁国际校区除外，学校会帮你付每月50的套餐）。通常10元/月套餐可以满足日常学习生活需求，如果对网速和连接设备数量有额外需求可以考虑升级套餐。

### 连接速率

参考[浙江大学信息技术中心](https://its.zju.edu.cn/_t2014/2020/0414/c49794a2058046/page.htm)公示，不同套餐的对应的网络限速为
...
Mbps：用于网络速度(如宽带、下载速率)， 换算关系为1MB/s = 8 Mbps。
...
为使用新版RVPN，需要先下载aTrust客户端。Windows、Mac OS、安卓用户可以[点此](https://vpn.zju.edu.cn)下载，IOS用户请在苹果应用商店搜索aTrust安装。安装完成后，点击软件图标，在软件的界面，选择登录方式后，输入账号密码后点击<登录>，获取短信验证码后输入，完成新版RVPN系统登录。更换设备或登录地变更可能会要求重新短信验证。

然而，深信服提供的aTrust客户端可能存在过度收集用户信息、卸载困难等问题，故本指南**强烈推荐**动手能力强的同学使使用来自CC98的[MythLi](https://zjuers.com/rd?url=https://www.cc98.org/user/id/619826&mode=1)开发的[ZJU Connect 多合一客户端](https://zjuers.com/rd?url=https://www.cc98.org/topic/6214942&mode=1)，部分替代了深信服的EasyConnect软件（尚不支持TUN模式与UDP协议）。同学们可以自行查看链接里的使用说明。
